...
From https://github.com/DarkEnergySurvey/ugali/blob/master/ugali/utils/projector.py
"""
...
class Projector:
    ...
    def __init__(self, lon_ref, lat_ref, proj_type = 'ait'):
        ...
        if proj_type.lower() == 'ait':
            ...
            print('%s not recognized'%(proj_type))
    ...
    def sphereToImage(self, lon, lat):
        ...
        if scalar: return x.item(), y.item()
    ...
    def imageToSphere(self, x, y):
        ...
        if scalar: return lon.item(), lat.item()
